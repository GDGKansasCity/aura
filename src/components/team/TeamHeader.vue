    ...
    <v-container fluid class="py-0 my-0 mt-2">
        <v-row align="center" class="py-0 my-0">
            <v-col md="12" sm="12" cols="12" class="py-0 my-0">
                ...
                <p class="google-font mt-0 ">Our goal is to organize space to connect the best industry experts with our audience to further education and interest in software development.</p>
